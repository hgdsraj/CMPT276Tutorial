...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post things_url, params: { thing: { description: @thing.description, person_id: @thing.person_id, tname: @thing.tname } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { description: @thing.description, person_id: @thing.person_id, tname: @thing.tname } }
